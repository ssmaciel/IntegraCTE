...
namespace IntegraCTE.Infra.Configuration
{
    public class TransportadoraConfiguration : IEntityTypeConfiguration<TransportadoraModel>
    {
        public void Configure(EntityTypeBuilder<TransportadoraModel> builder)
        {
            ...
            builder.Property(x => x.MetodoPagamento).HasMaxLength(20).IsRequired();
            builder.Property(x => x.EspecificacaoMetodoPagamento).HasMaxLength(10).IsRequired();
            builder.Property(x => x.CalendarioPagamento).HasMaxLength(100).IsRequired();
